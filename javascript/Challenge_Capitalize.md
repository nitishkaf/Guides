...
If you feel stuck and can not figure it out on your own, that is absolutely fine. We will walk you through the solution(s), so that you can understand how to solve the problem.

**Instructions**:

Take the variable `myString` and capitalize the first letter of the word using some of the methods. Put the result in a variable called `myNewString`.
